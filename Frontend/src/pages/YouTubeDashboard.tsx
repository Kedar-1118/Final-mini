...
export function YouTubeDashboard() {
  ...
  const fetchSentiment = async () => {
    try {
      ...
      const { data } = await API.get('/youtube/sentiment');
                ...
                {sentimentData && (
                  <div className="space-y-6">
                    <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-xl border border-purple-100 dark:border-purple-800">
                      <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Summary</h3>
                      <p className="text-purple-800 dark:text-purple-200">{sentimentData.summary}</p>
                    </div>
